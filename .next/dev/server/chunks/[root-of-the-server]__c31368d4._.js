...
"[project]/Otherworld_Interface/app/api/upload/route.jsx [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    try {
        ...
        const uploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join("C:\\Users\\Otherworld\\TD_Application\\PHL Box Office\\Assets\\Event Assets");
        try {
        ...
        return Response.json({
            success: true,
            filename,
            path: `C:\Users\Otherworld\TD_Application\PHL Box Office\Assets\Event Assets`,
            size: file.size,
            type: file.type
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c31368d4._.js.map